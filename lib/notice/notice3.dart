              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image.asset('assets/교육지3.jpg'),
                        SizedBox(height: 25),
                        Text.rich(
                          TextSpan(
                            text: "이전 7월 걷기미션 이벤트 안내  링크:\n",
                            style: TextStyle(fontSize: 15),
                            children: [
                              TextSpan(
                                text:
                                    "https://sd1in.net/communication/news?uid=165&mod=document&pageid=1",
                                style: TextStyle(
                                  fontSize: 15,
                                  color: Colors.blue,
                              ...
                              TextSpan(
                                text: "\n\n★ 걷기미션은 건강마루멤버십 회원 전용입니다!\n\n"
                                    "★ 7월 걷기미션 결과 발표 명단(전체 참여자 명단 및 순위) 링크\n",
                                style: TextStyle(fontSize: 15),
                              ),
                              TextSpan(
                                text:
                                    "https://docs.google.com/spreadsheets/d/1_FwuZYI3WXvcdKjakFEkha4aDU3TFqnY6QAKTi-j8cM/edit?usp=sharing",
                                style: TextStyle(
                                  fontSize: 15,
                                  color: Colors.blue,
                                  decoration: TextDecoration.underline,
